<template>
  <InsBimPlusViewer
    ref="bimViewer"
    :tileset-sources="tilesetSources"
    :gltf-sources="gltfSources"
    :env-config="envConfig"
    :material-config="materialConfig"
    @ready="onReady"
    @model-loaded="onModelLoaded"
    @error="onError"
    @gltf-pick="onPartClick"
  ...
  <div class="operation-container flex">
    ...
    <el-checkbox
      ...
      >地形</el-checkbox
    >
    <el-checkbox v-model="canansShow" @change="handleDualPassToggle"
      >双透视</el-checkbox
    >
    <el-checkbox v-model="labelsVisible" @change="handleRenderLabels"
      >标签</el-checkbox
    >
  </div>
</template>
